...
// Auto-generated page for: 3D virtual staging with AR export for mobile tours

export default function Cf3dVirtualStagingWithArExport() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-3d-virtual-staging-with-ar-export', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>3D virtual staging with AR export for mobile tours</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>3D virtual staging with AR export for mobile tours.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run 3D virtual staging with AR export for mobile tours'}
        </button>
      </form>
