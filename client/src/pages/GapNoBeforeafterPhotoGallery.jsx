...
// Auto-generated page for: No before/after photo gallery

export default function GapNoBeforeafterPhotoGallery() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-beforeafter-photo-gallery', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No before/after photo gallery</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No before/after photo gallery</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No before/after photo gallery'}
        </button>
      </form>
