...
// Auto-generated page for: Time-to-sale prediction tied to staging investment level

export default function CfTimeToSalePredictionTiedTo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-time-to-sale-prediction-tied-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Time-to-sale prediction tied to staging investment level</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Time-to-sale prediction tied to staging investment level.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Time-to-sale prediction tied to staging investment level'}
        </button>
      </form>
