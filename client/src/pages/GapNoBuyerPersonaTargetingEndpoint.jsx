...
// Auto-generated page for: No buyer persona targeting endpoint

export default function GapNoBuyerPersonaTargetingEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-buyer-persona-targeting-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No buyer persona targeting endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No buyer persona targeting endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No buyer persona targeting endpoint'}
        </button>
      </form>
