...
// Auto-generated page for: Buyer-persona psychology modeling per neighborhood/price poi

export default function CfBuyerPersonaPsychologyModelingPerNe() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-buyer-persona-psychology-modeling-per-ne', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Buyer-persona psychology modeling per neighborhood/price poi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Buyer-persona psychology modeling per neighborhood/price point.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Buyer-persona psychology modeling per neighborhood/price poi'}
        </button>
      </form>
