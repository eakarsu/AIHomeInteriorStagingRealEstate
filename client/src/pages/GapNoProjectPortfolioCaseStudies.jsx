...
// Auto-generated page for: No project portfolio / case studies

export default function GapNoProjectPortfolioCaseStudies() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-project-portfolio-case-studies', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No project portfolio / case studies</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No project portfolio / case studies</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No project portfolio / case studies'}
        </button>
      </form>
