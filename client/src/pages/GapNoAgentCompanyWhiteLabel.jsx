...
// Auto-generated page for: No agent / company white-label

export default function GapNoAgentCompanyWhiteLabel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-agent-company-white-label', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No agent / company white-label</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No agent / company white-label</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No agent / company white-label'}
        </button>
      </form>
