...
// Auto-generated page for: No competitor / MLS comp analysis endpoint

export default function GapNoCompetitorMlsCompAnalysisEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-competitor-mls-comp-analysis-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No competitor / MLS comp analysis endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No competitor / MLS comp analysis endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No competitor / MLS comp analysis endpoint'}
        </button>
      </form>
