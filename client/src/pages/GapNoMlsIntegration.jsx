...
// Auto-generated page for: No MLS integration

export default function GapNoMlsIntegration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mls-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No MLS integration</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No MLS integration</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No MLS integration'}
        </button>
      </form>
